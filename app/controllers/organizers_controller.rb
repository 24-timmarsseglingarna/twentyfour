class OrganizersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @organizer.save
        format.html { redirect_to @organizer, notice: 'Arrangören har lagts in.' }
  ...
  def update
    respond_to do |format|
      if @organizer.update(organizer_params)
        format.html { redirect_to @organizer, notice: 'Arrangören har uppdaterats' }
  ...
  def destroy
    @organizer.destroy
    respond_to do |format|
      format.html { redirect_to organizers_url, notice: 'Arrangören har raderats.' }
  ...
  private
    ...
    def organizer_params
      params.require(:organizer).permit(:name, :contact_name, :fk_org_code)
    end
end

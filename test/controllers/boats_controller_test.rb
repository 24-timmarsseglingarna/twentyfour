...
class BoatsControllerTest < ActionController::TestCase
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post :create, boat: { boat_type: @boat.boat_type, name: @boat.name, sail_number: @boat.sail_number }
    end
  ...
  test "should update boat" do
    patch :update, id: @boat, boat: { boat_type: @boat.boat_type, name: @boat.name, sail_number: @boat.sail_number }
    assert_redirected_to boat_path(assigns(:boat))
  end

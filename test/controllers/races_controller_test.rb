...
class RacesControllerTest < ActionController::TestCase
  ...
  test "should create race" do
    assert_difference('Race.count') do
      post :create, race: { period: @race.period, regattum_id: @race.regattum_id, start_from: @race.start_from, start_to: @race.start_to }
    end
  ...
  test "should update race" do
    patch :update, id: @race, race: { period: @race.period, regattum_id: @race.regattum_id, start_from: @race.start_from, start_to: @race.start_to }
    assert_redirected_to race_path(assigns(:race))
  end
